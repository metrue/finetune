...
const utils_1 = __nccwpck_require__(8981);
/**
 * Commands
 *
 * Command Format:
...
const command_1 = __nccwpck_require__(8886);
const file_command_1 = __nccwpck_require__(5223);
const utils_1 = __nccwpck_require__(8981);
const os = __importStar(__nccwpck_require__(2037));
 ...
 * Summary exports
 */
var summary_1 = __nccwpck_require__(7105);
Object.defineProperty(exports, "summary", ({ enumerable: true, get: function () { return summary_1.summary; } }));
/**
 * @deprecated use core.summary
 */
var summary_2 = __nccwpck_require__(7105);
Object.defineProperty(exports, "markdownSummary", ({ enumerable: true, get: function () { return summary_2.markdownSummary; } }));
/**
 * Path exports
 */
var path_utils_1 = __nccwpck_require__(106);
...
const os = __importStar(__nccwpck_require__(2037));
const uuid_1 = __nccwpck_require__(8609);
const utils_1 = __nccwpck_require__(8981);
...
const http_client_1 = __nccwpck_require__(9214);
const auth_1 = __nccwpck_require__(6908);
const core_1 = __nccwpck_require__(8076);
class OidcClient {
...
const pm = __importStar(__nccwpck_require__(4486));
const tunnel = __importStar(__nccwpck_require__(8714));
var HttpCodes;
(function (HttpCodes) {
...
var eventTargetShim = __nccwpck_require__(2985);
...
module.exports = __nccwpck_require__(3135);
module.exports.HttpsAgent = __nccwpck_require__(19);
module.exports.constants = __nccwpck_require__(7641);
...
const ms = __nccwpck_require__(6841);
...
const HttpAgent = __nccwpck_require__(3135);
const {
  INIT_SOCKET,
...
var ms = __nccwpck_require__(9843);
...
var whatwgUrl = _interopDefault(__nccwpck_require__(6809));
...
let convert;
try {
	convert = (__nccwpck_require__(9272).convert);
} catch (e) {}
...
var _v = _interopRequireDefault(__nccwpck_require__(3179));

var _v2 = _interopRequireDefault(__nccwpck_require__(5293));

var _v3 = _interopRequireDefault(__nccwpck_require__(3492));

var _v4 = _interopRequireDefault(__nccwpck_require__(6580));

var _nil = _interopRequireDefault(__nccwpck_require__(7779));

var _version = _interopRequireDefault(__nccwpck_require__(2646));

var _validate = _interopRequireDefault(__nccwpck_require__(8568));

var _stringify = _interopRequireDefault(__nccwpck_require__(6030));

var _parse = _interopRequireDefault(__nccwpck_require__(1776));
...
var _rng = _interopRequireDefault(__nccwpck_require__(1412));
...
var _v = _interopRequireDefault(__nccwpck_require__(536));
...
var _sha = _interopRequireDefault(__nccwpck_require__(9982));
...
var _regex = _interopRequireDefault(__nccwpck_require__(2233));
...
const usm = __nccwpck_require__(3646);
...
const conversions = __nccwpck_require__(8158);
const utils = __nccwpck_require__(1977);
const Impl = __nccwpck_require__(926);
...
exports.URL = __nccwpck_require__(3922)["interface"];
exports.serializeURL = __nccwpck_require__(3646).serializeURL;
exports.serializeURLOrigin = __nccwpck_require__(3646).serializeURLOrigin;
exports.basicURLParse = __nccwpck_require__(3646).basicURLParse;
exports.setTheUsername = __nccwpck_require__(3646).setTheUsername;
exports.setThePassword = __nccwpck_require__(3646).setThePassword;
exports.serializeHost = __nccwpck_require__(3646).serializeHost;
exports.serializeInteger = __nccwpck_require__(3646).serializeInteger;
exports.parseURL = __nccwpck_require__(3646).parseURL;
...
const tr46 = __nccwpck_require__(4864);
...
const createBoundary_1 = __importDefault(__nccwpck_require__(29));
const isPlainObject_1 = __importDefault(__nccwpck_require__(3694));
const normalizeValue_1 = __importDefault(__nccwpck_require__(1282));
const escapeName_1 = __importDefault(__nccwpck_require__(2887));
const isFileLike_1 = __nccwpck_require__(4836);
const isFormData_1 = __nccwpck_require__(1715);
...
__exportStar(__nccwpck_require__(6773), exports);
...
const isFunction_1 = __importDefault(__nccwpck_require__(7788));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Blob = void 0;
const web_streams_polyfill_1 = __nccwpck_require__(7740);
const isFunction_1 = __nccwpck_require__(421);
const blobHelpers_1 = __nccwpck_require__(1869);
class Blob {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.File = void 0;
const Blob_1 = __nccwpck_require__(2731);
...
const File_1 = __nccwpck_require__(1638);
const isFile_1 = __nccwpck_require__(696);
const isBlob_1 = __nccwpck_require__(5430);
const isFunction_1 = __nccwpck_require__(421);
const deprecateConstructorEntries_1 = __nccwpck_require__(6357);
class FormData {
    constructor(entries) {
...
const node_domexception_1 = __importDefault(__nccwpck_require__(6583));
const File_1 = __nccwpck_require__(1638);
const isPlainObject_1 = __importDefault(__nccwpck_require__(3699));
__exportStar(__nccwpck_require__(696), exports);
...
__exportStar(__nccwpck_require__(2731), exports);
...
const agentkeepalive_1 = __importDefault(__nccwpck_require__(2276));
const abort_controller_1 = __nccwpck_require__(5899);
...
const nf = __nccwpck_require__(3708);
...
const file_from_path_1 = __nccwpck_require__(2614);
let warned = false;
...
const fd = __nccwpck_require__(9299);
...
const form_data_encoder_1 = __nccwpck_require__(3955);
const uploads_1 = __nccwpck_require__(3928);
...
exports.toBase64 =
  ...
  exports.maybeMultipartFormRequestOptions =
    void 0;
const version_1 = __nccwpck_require__(7594);
const streaming_1 = __nccwpck_require__(3843);
const error_1 = __nccwpck_require__(9393);
const agent_1 = __nccwpck_require__(9594);
const fetch_1 = __nccwpck_require__(1202);
const uploads_1 = __nccwpck_require__(3928);
var uploads_2 = __nccwpck_require__(3928);
...
exports.InternalServerError =
  ...
  exports.APIError =
    void 0;
const core_1 = __nccwpck_require__(3162);
...
exports.fileFromPath =
  ...
  exports.OpenAI =
    void 0;
const Core = __importStar(__nccwpck_require__(3162));
const Pagination = __importStar(__nccwpck_require__(2958));
const API = __importStar(__nccwpck_require__(9174));
const Errors = __importStar(__nccwpck_require__(9393));
const Uploads = __importStar(__nccwpck_require__(3928));
...
const resource_1 = __nccwpck_require__(364);
const transcriptions_1 = __nccwpck_require__(7464);
const translations_1 = __nccwpck_require__(3107);
const API = __importStar(__nccwpck_require__(6815));
...
var audio_1 = __nccwpck_require__(286);
...
var transcriptions_1 = __nccwpck_require__(7464);
...
var translations_1 = __nccwpck_require__(3107);
...
exports.Chat = void 0;
const resource_1 = __nccwpck_require__(364);
const completions_1 = __nccwpck_require__(6756);
const API = __importStar(__nccwpck_require__(1969));
...
var chat_1 = __nccwpck_require__(1856);
...
var completions_1 = __nccwpck_require__(6756);
...
const resource_1 = __nccwpck_require__(364);
const core_1 = __nccwpck_require__(3162);
const pagination_1 = __nccwpck_require__(2958);
...
const resource_1 = __nccwpck_require__(364);
const jobs_1 = __nccwpck_require__(4800);
const API = __importStar(__nccwpck_require__(3031));
...
var fine_tuning_1 = __nccwpck_require__(6336);
...
var jobs_1 = __nccwpck_require__(4800);
...
var completions_1 = __nccwpck_require__(2494);
Object.defineProperty(exports, "Completions", ({
  enumerable: true,
  get: function () {
    return completions_1.Completions;
...
var embeddings_1 = __nccwpck_require__(2657);
...
var edits_1 = __nccwpck_require__(7178);
...
var files_1 = __nccwpck_require__(3668);
...
var fine_tunes_1 = __nccwpck_require__(7054);
...
var images_1 = __nccwpck_require__(447);
...
var models_1 = __nccwpck_require__(4855);
...
var moderations_1 = __nccwpck_require__(886);
...
exports.createForm =
  ...
  exports.fileFromPath =
    void 0;
const formdata_1 = __nccwpck_require__(4722);
const getMultipartRequestOptions_1 = __nccwpck_require__(7890);
const fileFromPath_1 = __nccwpck_require__(7261);
...
const node_readable_1 = __nccwpck_require__(7829);
...
const main = async () => {
  ...
  if (job.id) {
    ...
    while (wait) {
      count += 1
      let done = false
      const res = openai.fineTunes.list()
